...
export class AlterTableUserPreferencesUserId1742917418825 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			'ALTER TABLE "UserPreferences" ADD CONSTRAINT "FK_5f8256554b2eec66fda266f625b" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
		);
	}
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			'ALTER TABLE "UserPreferences" ADD CONSTRAINT "user_id" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE',
		);
	}
}
